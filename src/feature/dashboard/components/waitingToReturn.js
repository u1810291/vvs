          ...
          <div className='flex flex-row w-full'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <div className='flex flex-col'>
                ...
                <button className='flex justify-center py-1 mt-2 mr-2 rounded-sm px-4 border border-transparent text-xs font-normal text-white font-montserrat hover:shadow-none hover:bg-slate-500  bg-slate-600 focus:outline-none'>
                  {t`left.regurgitate`}
                </button>
              </div>
