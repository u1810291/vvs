...
const CLASS_NAME = 'inline-flex items-center justify-center border border-transparent loading-none font-medium rounded-md shadow-sm text-white bg-oxford hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford'
