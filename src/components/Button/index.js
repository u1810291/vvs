...
const CLASS_NAME_PRIMARY = 'inline-flex items-center justify-center border border-transparent loading-none font-medium rounded-md shadow-sm text-white bg-oxford hover:bg-oxford-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford';
const CLASS_NAME_SECONDARY = 'inline-flex items-center justify-center border border-transparent loading-none font-medium rounded-md shadow-sm text-regent bg-geyser hover:bg-geyser-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford';
const CLASS_NAME_DANGER = 'inline-flex items-center justify-center border border-transparent loading-none font-medium rounded-md shadow-sm text-white bg-brick hover:bg-brick-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford';
