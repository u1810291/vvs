...
export const DashboardList = ({
  ...
  return (
    <div
      {...props}
      className="w-full border grid grid-cols-1 bg-white grid-rows-1 grid-flow-row table-auto sm:grid-cols-9 grid-gap-6 justify-between font-normal text-black z-1"
    >
      ...
      <span className="flex bg-white text-gray-500 self-center">{reason}</span>
      </div>
    </div>
  );
};
