          ...
          <div key={filter.id}>
            <div className="w-full border-b grid grid-cols-1 bg-white grid-rows-1 grid-flow-row table-auto md:grid-cols-12 grid-gap-6 justify-between font-normal text-black z-1">
              <div className="flex flex-row items-center h-12">
                <span className="bg-white text-gray-400 truncate text-sm">{date}</span>
              </div>
              ...
              <div className="flex row-span-2 items-center h-12">
                <span className="bg-white text-gray-400 truncate text-sm">{crew}</span>
              </div>
              <div className="flex flex-row items-center h-12">
                <span className="bg-white text-gray-400 truncate text-sm">
                  {intime}
              ...
              <div className="flex flex-row h-12 items-center">
                <span className="bg-white text-gray-400 text-sm">{reactiontime}</span>
              </div>
              <div className="flex flex-row items-center h-12">
                <span className="bg-white text-gray-400 text-sm">{timeinobject}</span>
              </div>
