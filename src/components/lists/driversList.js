...
export const DriverList = () => {
  ...
  useEffect(() => {
    if (driversNamesRef.current === null) {
      setDriversNamesDefault("false");
    }
    if (driversStatusRef.current === null) {
      setDriversStatusDefault("false");
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [driversNamesRef.current, driversStatusRef.current]);
        ...
        <>
          <div className="flex pl-4 w-full border-t py-2 bg-gray-100 justify-between font-normal text-black z-1">
            <div className="flex flex-row items-center justify-start w-40">
              {driversNamesDefault === "true" ||
              driversNamesDefault === "default" ? (
                <button
            ...
            {driversStatusDefault === "true" ||
            driversStatusDefault === "default" ? (
              <button
