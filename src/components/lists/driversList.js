  ...
  return (
    <div className="w-full" {...props}>
      {filterList.map((filter, index) => {
        return (
          <div key={filter.id}>
            <div className="w-full border-b grid grid-cols-2 bg-white grid-rows-1 grid-flow-row table-auto md:grid-cols-2 grid-gap-6 justify-between font-normal text-black z-1">
