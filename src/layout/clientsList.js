  ...
  return (
    <>
      {!sortedClients ? (
        ...
        <div className="flex h-screen w-screen bg-gray-100 justify-center items-center">
          <Link to="/">
            <button className="flex text-gray-400 justify-centerrounded-smtext-xs hover:text-gray-500 font-normal hover:shadow-none bg-gray-200 focus:outline-none">something went wrong</button>
          </Link>
        </div>
      ) : (
